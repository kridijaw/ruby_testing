...
describe NumberGame do
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        two_digit_number = '42'
        valid_input = '1'
        allow(game_loop).to receive(:player_input).and_return(letter, two_digit_number, valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      it 'outputs correct phrase' do
        tough_phrase = "That was hard. It took you 4 guesses!\n"
        expect { game_four.final_message }.to output(tough_phrase).to_stdout
      end
    end
  end
end
